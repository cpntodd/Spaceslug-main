...
def pick_files(root: str | Path, *, recursive: bool = True, extensions: tuple[str, ...] = (".txt", ".md", ".jsonl", ".pdf"), max_bytes: int = 16 * 1024 * 1024, exclude: tuple[str, ...] = (".git", ".venv")) -> FileSelection:
